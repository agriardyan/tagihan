    ...
    <body>
        ...
        <div class="ui one column page grid" id="formCek">
            <div class="column">
                <!--Search box-->
                <!--End of Search box-->
                <form class="ui fluid form segment" action="<?php echo base_url('subbagpembayaran'); ?>" id="registrasiForm" >
                    <div class="fields">
                        <h2><font face="calibri"> Terima kasih </font></h2>
                        <h4><font face="calibri"> Dokumen tagihan berhasil diteruskan ke DM Anggaran & Keuangan </font></h4>
                        <br>
                    </div>    
                    <div class="two fields">
                        <div class="field">
                            <br>
                            <input class="ui blue submit button" type="submit" value="KEMBALI">
                        </div>
                        <div class="field">
