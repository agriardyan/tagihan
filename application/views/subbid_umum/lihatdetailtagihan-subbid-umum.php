...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Lihat Detail Tagihan - Subbid Umum</title>
    </head>
    <body>
        ...
        <div class="ui one column page grid">
            <div class="column">
                ...
                <?php echo form_open(base_url('subbidumum/simpan')); ?>
                ...
                <input class="ui blue submit button" type="submit" name="commit" value="AGENDAKAN">
                <?php 
