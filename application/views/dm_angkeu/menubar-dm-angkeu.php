...
<html>
    ...
    <body>
        ...
        ?>
        <div class="ui menu">
            <a class="item" id="sche" href="<?php echo base_url('dmangkeu'); ?>">
                <i class="book icon"></i> HOME
            </a>
            <a class="item" id="sche" href="<?php echo base_url('dmangkeu/baru'); ?>">
                <i class="book icon"></i> TAGIHAN BARU
            </a>
            <div class="right menu">
                <form action="<?php echo base_url('logout'); ?>" method="POST">
                    <div class="ui dropdown link item">
                        <i class="user icon"></i> DM ANGGARAN KEUANGAN <i class="dropdown icon"></i>
                        <div class="menu">
