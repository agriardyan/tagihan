...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Lihat Dokumen Kembali - Subbid Umum</title>
    </head>
    <body>
        <?php
        // put your code here
        ...
        <div class="ui form segment">
            <h4 class="ui dividing header">Daftar Tagihan dikembalikan oleh Subbid terkait</h4>
                    ...
                    <tr>
                        <?php foreach ($dbresult as $key => $value) { ?>
                            ...
                            <td class="center aligned">
                                <?php
                                echo form_open(base_url('subbidumum/detail'));
