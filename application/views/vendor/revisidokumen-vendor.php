        ...
        <div class="ui one column page grid">
            <div class="column">
                ...
                <div class="ui fluid form segment">
                    ...
                    <div class="two fields">
                        ...
                        <div class="field">
                            ...
                            <div class="ui left labeled icon input">
                                <input name="nomortagihan" placeholder="e.g. 01/TAG/VI/2015" type="text" value="<?php echo @$specifictagihan['nomor_tagihan']; ?>" >
                    ...
                    <?php 
                    echo form_hidden('hidden_idkontrak', @$specifictagihan['id_kontrak']);
